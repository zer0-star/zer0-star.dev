...
h1 = JE.h1 [ "class" := "font-Quicksand font-light text-5xl tracking-tightest my-4 before:content-['#'] before:mr-1 before:text-3xl before:tracking-tight" ]

h2 :: forall context. Component context -> Component context
h2 = JE.h2 [ "class" := "font-Quicksand font-light text-4xl tracking-tightest my-4 before:content-['##'] before:mr-1 before:text-2xl before:tracking-tight" ]
